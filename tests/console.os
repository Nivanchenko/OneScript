...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПрисваиваниеВКонсоль");
...
Процедура ТестДолжен_ПроверитьПрисваиваниеВКонсоль() Экспорт

	Консоль = Новый Консоль;
	юТест.ПроверитьТип(Консоль, Тип("Консоль"));
